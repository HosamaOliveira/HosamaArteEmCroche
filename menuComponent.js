  ...
  <div id="sideMenuShadow"></div>
	...
	<nav id="sub-menu">
		...
		<div id="contentMenu">
			...
			<div id="contentLink">  
				<div class="link"><a href="index.html"><button class="naviMenu" id="home">Home</button></a></div>
				<div class="link"><a href="./fotos.html" target="_blank"><button class="naviMenu" id="photos">Galeria</button></a></div>
